...
data1 = pd.read_csv('E:/python program/lstm-imdb/GRU/gru-feature-combine-gru-2.csv')
...
np.savetxt(r'E:\python program\lstm-imdb\HGP\hgp-feature-combine-hgpgru.csv',xx2,delimiter=',', fmt=('%d,%f,%d,%f,%f,%d,%f,%d,%f,%f,%f'))
