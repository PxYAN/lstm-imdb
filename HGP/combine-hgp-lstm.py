...
data1 = pd.read_csv('E:/python program/lstm-imdb/LSTM/10-29-epoch-88-batchsize-128-LSTM-35/lstm-feature-combine.csv')
...
np.savetxt(r'E:\python program\lstm-imdb\HGP\hgp-feature-combine-hgplstm.csv',xx2,delimiter=',', fmt=('%d,%f,%d,%f,%f,%d,%f,%d,%f,%f,%f'))
