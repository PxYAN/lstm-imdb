...
def bianli(i):
    ...
    data = pd.read_csv('E:\python program\lstm-imdb\HGP\hgp-feature-combine-hgplstm.csv')
    ...
    model=tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(64,input_shape=(11,),activation='sigmoid'),
...
# print(bianli(41)) #176 77.36% 40-73.27% gru-feature-combine-gru-hgp.csv
