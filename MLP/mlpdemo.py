...
def bianli(i):
    ...
    # data=pd.read_csv('E:\python program\lstm-imdb\LSTM\lstm-feature-combine.csv')
    ...
    model.compile(
        ...
        metrics=['accuracy',tf.keras.metrics.AUC(curve='ROC', name='auc'),F1_Score()]
        # metrics=['accuracy']
...
# print(bianli(41)) 572-75% 9-74.52%(test-balance-2)
# print(bianli(41))  (1-1000)18-75.79%(test-balance-1)
bianli(9)
