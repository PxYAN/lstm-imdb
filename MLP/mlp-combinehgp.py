...
def bianli(i):
    ...
    data = pd.read_csv('E:\python program\lstm-imdb\HGP\hgp-feature-combine-hgp.csv')
    ...
    model=tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(64,input_shape=(10,),activation='sigmoid'),
...
# print(bianli(41)) # 619-76.73% 18-76.84% hgp-feature-combine-hgp.csv
