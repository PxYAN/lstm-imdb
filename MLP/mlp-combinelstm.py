...
def bianli(i):
    ...
    # data=pd.read_csv('E:/python program/lstm-imdb/LSTM/lstm-feature-combine-lstm-all-2.csv')
    data = pd.read_csv('E:/python program/lstm-imdb/LSTM/10-29-epoch-88-batchsize-128-LSTM-35/lstm-feature-combine.csv')
...
# print(bianli(41)) # 180-68% 41-65% lstm-feature-combine-lstm-all(test-balance-2)
# print(bianli(41)) # 707-75.47% 18-72.95% lstm-feature-combine-lstm-1(test-balance-2)
# print(bianli(41)) # 619-76.73% 18-75.15% lstm-feature-combine-lstm-1-2(test-balance-1)
# print(bianli(41)) # 872-69.50% 39-64.15% lstm-feature-combine-lstm-all-2(test-balance-1)
