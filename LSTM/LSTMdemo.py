...
h = model.fit(X_train, y_train, epochs=88, batch_size=128) # 64 128
...
#尝试将static-feature和LSTM-feature合并
data2 = model.predict(X_all)
# np.savetxt(r'E:\python program\lstm-imdb\LSTM\10-29-epoch-88-batchsize-128-LSTM-35\lstm-feature-output.csv',output,delimiter=',', fmt=('%f'))
