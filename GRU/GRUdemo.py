...
h = model.fit(X_train, y_train, epochs=88, batch_size=128) # 64 120
# h = model.fit(X_train, y_train, epochs=10, batch_size=256,validation_split=0.2,callbacks=[callback]) # 64 90 32
...
np.savetxt(r'E:\python program\lstm-imdb\GRU\gru-feature-combine(logsigmoid).csv',output,delimiter=',', fmt=('%f'))
# data1 = pd.DataFrame(xx)
# print(data1)
# data1.to_csv('E:\python program\lstm-imdb\GRU\est1212.csv', index=False)
