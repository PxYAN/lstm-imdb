...
data2 = pd.read_csv('E:/python program/lstm-imdb/GRU/gru-feature-combine.csv')
...
np.savetxt(r'E:\python program\lstm-imdb\GRU\gru-feature-combine-gru-2.csv',xx2,delimiter=',', fmt=('%d,%f,%d,%f,%f,%d,%f,%d,%f'))
